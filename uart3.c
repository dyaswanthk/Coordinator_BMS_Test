...
void uart3_dma_init(uint8_t size)
{
    ...
    DMA1_Stream3->CR &= ~DMA_SxCR_CHSEL;            // DMA1-Stream3-channel4 corresponds to uart3_TX
    ...
    DMA1_Stream1->CR &= ~DMA_SxCR_CHSEL;            // DMA1-Stream1-channel4 corresponds to uart3_RX
